...
public class ModelInfo implements org.apache.thrift.TBase<ModelInfo, ModelInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ModelInfo> {
  ...
  private static final org.apache.thrift.protocol.TField CV_SCORE_FIELD_DESC = new org.apache.thrift.protocol.TField("cvScore", org.apache.thrift.protocol.TType.MAP, (short)10);
  ...
  public Map<String,Double> cvScore; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.CV_SCORE, new org.apache.thrift.meta_data.FieldMetaData("cvScore", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public ModelInfo(ModelInfo other) {
    ...
    if (other.isSetCvScore()) {
      Map<String,Double> __this__cvScore = new HashMap<String,Double>(other.cvScore);
      this.cvScore = __this__cvScore;
    }
  ...
  public int getCvScoreSize() {
    return (this.cvScore == null) ? 0 : this.cvScore.size();
  }

  public void putToCvScore(String key, double val) {
    if (this.cvScore == null) {
      this.cvScore = new HashMap<String,Double>();
    }
    this.cvScore.put(key, val);
  }

  public Map<String,Double> getCvScore() {
    return this.cvScore;
  }

  public ModelInfo setCvScore(Map<String,Double> cvScore) {
    this.cvScore = cvScore;
    return this;
  }

  public void unsetCvScore() {
    this.cvScore = null;
  }

  /** Returns true if field cvScore is set (has been assigned a value) and false otherwise */
  public boolean isSetCvScore() {
    return this.cvScore != null;
  }

  public void setCvScoreIsSet(boolean value) {
    if (!value) {
      this.cvScore = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CV_SCORE:
      if (value == null) {
        ...
        setCvScore((Map<String,Double>)value);
      }
      break;
  ...
  public boolean equals(ModelInfo that) {
    ...
    boolean this_present_cvScore = true && this.isSetCvScore();
    boolean that_present_cvScore = true && that.isSetCvScore();
    if (this_present_cvScore || that_present_cvScore) {
      if (!(this_present_cvScore && that_present_cvScore))
        return false;
      if (!this.cvScore.equals(that.cvScore))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_cvScore = true && (isSetCvScore());
    list.add(present_cvScore);
    if (present_cvScore)
      list.add(cvScore);
  ...
  public int compareTo(ModelInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetCvScore()).compareTo(other.isSetCvScore());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCvScore()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cvScore, other.cvScore);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ModelInfoStandardScheme extends StandardScheme<ModelInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cvScore = new HashMap<String,Double>(2*_map38.size);
                String _key39;
                double _val40;
                for (int _i41 = 0; _i41 < _map38.size; ++_i41)
                {
                  ...
                  struct.cvScore.put(_key39, _val40);
                }
                iprot.readMapEnd();
              }
              struct.setCvScoreIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ModelInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.cvScore != null) {
        oprot.writeFieldBegin(CV_SCORE_FIELD_DESC);
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, struct.cvScore.size()));
          for (Map.Entry<String, Double> _iter42 : struct.cvScore.entrySet())
          {
  ...
  private static class ModelInfoTupleScheme extends TupleScheme<ModelInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ModelInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCvScore()) {
        {
          oprot.writeI32(struct.cvScore.size());
          for (Map.Entry<String, Double> _iter43 : struct.cvScore.entrySet())
          {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.cvScore = new HashMap<String,Double>(2*_map44.size);
          String _key45;
          double _val46;
          for (int _i47 = 0; _i47 < _map44.size; ++_i47)
          {
            ...
            struct.cvScore.put(_key45, _val46);
          }
        }
        struct.setCvScoreIsSet(true);
      }
