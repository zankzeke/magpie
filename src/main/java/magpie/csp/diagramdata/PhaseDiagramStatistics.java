 ...
 * <li>Train the cumulant functions by calling {@linkplain #getCumulants(PrototypeDataset, boolean[])} }
 * <li>Use those functions predictively by calling {@linkplain #evaluateProbability(PrototypeEntry, double[][], double)}
 * </ol>
 * 
...
public abstract class PhaseDiagramStatistics implements Serializable {
     ...
     *  and their possible values are described in {@linkplain #getVariableVector(PrototypeEntry)}
     ...
     * @param cumulant Cumulant function values generated by {@linkplain #getCumulants(PrototypeDataset, boolean[])}
